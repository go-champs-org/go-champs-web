export default {
  translation: {
    ...
    editGame: 'Edit game',
    editOfficialProfile: 'Edit official profile',
    ...
    gameAssetType: {
      fibaScoresheet: 'FIBA Scoresheet',
      fibaBoxscore: 'FIBA Boxscore',
    ...
    newCoach: 'New coach',
    newDraw: 'New draw',
    newGroupStandings: 'New group standings',
    newFixedPlayerStatsTable: 'New players stats table',
    newGame: 'New game',
    newOfficial: 'New official',
    newOfficialProfile: 'New official profile',
    ...
    repeatedSignaturePin: 'Repeat signature PIN',
    required: 'Required',
    ...
    isTrialTournament: 'Tournament in trial mode',
    signIn: 'Sign in',
    ...
    checkingUsernameAvailability: 'Checking availability',
    usernameAvailable: 'Username available',
    usernameTooShort: 'Must be at least 4 characters',
    usernameTooLong: 'Must be at most 20 characters',
    usernameInvalidCharacters: 'Use only letters, numbers, dots and hyphens',
    usernameTaken: 'This username is already taken',
    usernameSuggestionOffer: 'Available suggestion: {{username}}',
    ...
    seeOfficialProfile: 'Check your Official Profile',
    createAthleteProfile: 'Create your Athlete Profile',
    createOfficialProfile: 'Create your Official Profile',
