...
export default {
  translation: {
    ...
    ruanBio:
      'Gosto de trabalhar em ambientes onde problemas difíceis são a norma e a qualidade da engenharia é levada a sério.',
    wagnerBio:
    ...
    actions: 'Acões',
    addAsset: 'Adicionar artefato',
    addOfficial: 'Adicionar oficial',
    ...
    nameFormatSettings: 'Configuracões de formato de nome',
    ...
    newGroupStandings: 'Nova classificação de grupos',
    newFixedPlayerStatsTable: 'Nova tabela de estatiticas de atletas',
    newGame: 'Nova partida',
    newOfficial: 'Novo oficial',
    newOfficialProfile: 'Novo perfil do oficial',
    ...
    photo: 'Foto',
    pin: 'Fixar',
    pinsMustMatch: 'PINs devem ser iguais',
    player: 'Atleta',
    ...
    remove: 'Remover',
    removeIdentity: 'Remover identidade',
    ...
    repeatedSignaturePin: 'Repita o PIN da assinatura',
    ...
    searchOfficialProfilePlaceholder:
      'Buscar por nome, usuário ou número de licença...',
    ...
    sports: {
      basketball_5x5: {
        ...
        statistics: {
          ...
          disqualifications: {
            abbreviation: 'DISQ',
            title: 'Desqualificacões'
          },
          disqualifications_per_game: {
            abbreviation: 'DISQ',
            title: 'Desqualificacões por jogo'
          },
          efficiency: {
            abbreviation: 'EFF',
            title: 'Eficiência'
          ...
          minutes_played_per_game: {
            abbreviation: 'MIN',
            title: 'Minutos jogados por jogo'
          },
          points: {
            abbreviation: 'PTS',
            title: 'Pontos'
          ...
          rebounds_defensive_per_game: {
            abbreviation: 'REB',
            title: 'Rebotes defensivos por jogo'
          },
          rebounds_offensive: {
            abbreviation: 'REB',
          ...
          rebounds_offensive_per_game: {
            abbreviation: 'REB',
            title: 'Rebotes ofensivos por jogo'
          },
          rebounds: {
            abbreviation: 'REB',
            title: 'Rebotes'
    ...
    sum: 'Soma',
    summary: 'Resumidas',
    uploadDropFiles: 'Arraste arquivos aqui',
    ...
    seeOfficialProfile: 'Confira seu Perfil de Oficial',
    createAthleteProfile: 'Crie seu Perfil de Atleta',
    createOfficialProfile: 'Crie seu Perfil de Oficial',
