module.exports = {
  ...
  'Add new game': function (client) {
    client
      ...
      .pause(1000)
      .setValue("//*[contains(text(), 'Away team')]/../div/div/div/div/div/div/div/div/input", ['Test team (cannot delete) A', client.Keys.ENTER])
      .setValue("//*[contains(text(), 'Home team')]/../div/div/div/div/div/div/div/div/input", ['Test team (cannot delete) B', client.Keys.ENTER])
