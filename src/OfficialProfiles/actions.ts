...
export const DELETE_OFFICIAL_PROFILE_SUCCESS = 'DELETE_OFFICIAL_PROFILE_SUCCESS';
export const DELETE_OFFICIAL_PROFILE_FAILURE = 'DELETE_OFFICIAL_PROFILE_FAILURE';
