...
interface PhaseGroupEditMatch extends TournamentHomeMatchProps {
  tournamentGroupId: string;
}

interface PhaseGroupEditProps extends RouteComponentProps<PhaseGroupEditMatch> {
...
class PhaseGroupEdit extends React.Component<PhaseGroupEditProps> {
  render() {
