...
function PrivacyPolicy() {
  return (
    <div className="content">
      ...
      <p className="subtitle">Last updated: September 18, 2020</p>
      ...
      <h2 className="title is-5">Interpretation</h2>
      <p>
      ...
      <h2 className="title is-5">Definitions</h2>
      ...
      <h1 className="title is-4">Collecting and Using Your Personal Data</h1>
      <h2 className="title is-5">Types of Data Collected</h2>
      <h3 className="title is-6">Personal Data</h3>
      <p>
      ...
      <h3 className="title is-6">Usage Data</h3>
      ...
      <h3 className="title is-6">Tracking Technologies and Cookies</h3>
      <p>
      ...
      <h2 className="title is-5">Use of Your Personal Data</h2>
      ...
      <h2 className="title is-5">Retention of Your Personal Data</h2>
      <p>
      ...
      <h2 className="title is-5">Transfer of Your Personal Data</h2>
      <p>
      ...
      <h2 className="title is-5">Disclosure of Your Personal Data</h2>
      <h3 className="title is-6">Business Transactions</h3>
      <p>
      ...
      <h3 className="title is-6">Law enforcement</h3>
      <p>
        Under certain circumstances, the Company may be required to disclose
        Your Personal Data if required to do so by law or in response to valid
        requests by public authorities (e.g. a court or a government agency).
      </p>
      <h3 className="title is-6">Other legal requirements</h3>
      <p>
      ...
      <h2 className="title is-5">Security of Your Personal Data</h2>
      <p>
      ...
      <h1 className="title is-4">Links to Other Websites</h1>
      <p>
      ...
      <h1 className="title is-4">Changes to this Privacy Policy</h1>
      <p>
      ...
      <ul>
        <li>
          <p>By email: contact@go-champs.com</p>
        </li>
        <li>
          <p>
            By visiting this page on our website:{' '}
            <a
              href="https://go-champs.com/PrivacyPolicy"
              rel="external nofollow noopener noreferrer"
              target="_blank"
              className="has-text-primary"
            >
              https://go-champs.com/PrivacyPolicy
            </a>
          </p>
        </li>
      </ul>
