...
import './PrivacyPolicyBR.scss';

function PrivacyPolicyBR() {
  return (
    <div className="content">
      <h1 className="title">Política de Privacidade</h1>

      <p className="subtitle">Última atualização: 11/04/2026</p>

      <h2 className="title is-4">1. Introdução</h2>
      <p>
        A Go Champs valoriza a sua privacidade e está comprometida com a
        proteção dos dados pessoais dos usuários, em conformidade com a Lei
      ...
      <h2 className="title is-4">2. Coleta de Dados</h2>
      ...
      <ul>
        ...
        <ul>
          ...
          <li>
            Dados de localização (informações sobre sua localização geográfica,
            se permitido)
          </li>
      ...
      <h2 className="title is-4">3. Uso de Dados</h2>
      ...
      <h2 className="title is-4">4. Compartilhamento de Dados</h2>
      <p>Não vendemos dados pessoais.</p>

      <p>Podemos compartilhar dados com:</p>
      <ul>
        <li>
          Prestadores de serviços (ex: hospedagem, analytics, publicidade)
        </li>
        <li>Parceiros necessários para operação da plataforma</li>
      </ul>

      <p>
        Todos os terceiros seguem padrões adequados de segurança e proteção de
        dados.
      </p>

      <h2 className="title is-4">5. Armazenamento e segurança</h2>

      <p>
        Adotamos medidas de segurança para proteger seus dados contra acesso não
      ...
      <h2 className="title is-4">6. Direitos do Usuário</h2>
      ...
      <h2 className="title is-4">7. Cookies e publicidade</h2>
      ...
      <p>
        ...
        cookies (incluindo o cookie DoubleClick) para exibir anúncios
        personalizados com base nas visitas anteriores do usuário a este e a
        outros sites.
      </p>

      <p>
        O Google e seus parceiros podem usar cookies para veicular anúncios
        personalizados.
      </p>
      ...
      <p>
        Para mais informações sobre como o Google gerencia dados em produtos de
        publicidade:{' '}
        <a
      ...
      <h2 className="title is-4">8. Transferência internacional de dados</h2>

      <p>
        Podemos transferir seus dados para servidores localizados fora do
        Brasil, garantindo que as medidas de proteção adequadas estejam em vigor
        para proteger suas informações.
      </p>

      <h2 className="title is-4">9. Alterações nesta política</h2>
      <p>
      ...
      <h2 className="title is-4">10. Contato</h2>
      <p>
        Se você tiver dúvidas ou preocupações sobre esta política de
        privacidade, entre em contato conosco pelo e-mail: contato@go-champs.com
      </p>
    </div>
  );
}

export default PrivacyPolicyBR;
