...
interface TournamentGroupListProps extends RouteComponentProps<TournamentHomeMatchProps> {
...
export default withTournaments(connect(mapStateToProps, mapDispatchToProps)(TournamentGroupList));