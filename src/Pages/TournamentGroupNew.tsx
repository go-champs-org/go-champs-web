...
interface TournamentGroupNewProps extends RouteComponentProps<TournamentHomeMatchProps> {
...
export default withTournaments(connect(state => state, mapDispatchToProps)(TournamentGroupNew));