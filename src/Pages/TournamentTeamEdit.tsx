...
interface TournamentTeamEditProps extends RouteComponentProps<TournamentTeamEditMatch> {
...
class TournamentTeamEdit extends React.Component<TournamentTeamEditProps> {
	render() {
		const tournamentTeam = this.props.tournamentTeamState.tournamentTeams[this.props.match.params.tournamentTeamId];
		return (
			<Form
...
export default withTournaments(connect(mapStateToProps, mapDispatchToProps)(TournamentTeamEdit));