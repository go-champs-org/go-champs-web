...
describe('formatStatNumber', () => {
  describe('small numbers (< 1000)', () => {
    it('rounds to nearest 100', () => {
      ...
      expect(formatStatNumber(50)).toBe('+100');
  ...
  describe('edge cases', () => {
    ...
    it('handles single digits', () => {
      ...
      expect(formatStatNumber(5)).toBe('+0');
      expect(formatStatNumber(9)).toBe('+0');
    });

    it('handles small values that round to 100', () => {
      expect(formatStatNumber(49)).toBe('+0');
      expect(formatStatNumber(51)).toBe('+100');
    });
  });
