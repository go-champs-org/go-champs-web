...
class TeamStatsStructure extends React.Component<FieldRenderProps<any, HTMLElement>> {
						...
						return (
							<div className="columns is-multiline">
								<FieldArray name="customers">
									{({ fields }: any) => fields.map((name: any, index: any) => {
										return (
											<div key={name}>
												<div className="column is-6">
													<Field name="title" component={StringInput} placeholder="Title" />
												</div>

												<div className="column is-6">
													<div className="columns is-gapless is-mobile">
														<div className="column is-10">
															<Field name="key" component={StringInput} placeholder="key" />
														</div>
