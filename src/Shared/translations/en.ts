export default {
  translation: {
    ...
    billingAgreementAcceptedSuccessfully:
      'Billing agreement accepted successfully!',
    billingAgreementAlreadyAccepted: 'Billing Agreement Already Accepted',
    billingContractSlug: 'Contract Slug',
    billingContractTerms: 'Billing Contract Terms',
    by: 'by',
