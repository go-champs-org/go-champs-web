...
export default {
  translation: {
    ...
    billing: 'Faturamento',
    billingAgreement: 'Contrato de Faturamento',
    billingAgreementAcceptedSuccessfully:
      'Contrato de faturamento aceito com sucesso!',
    billingAgreementAlreadyAccepted: 'Contrato de Faturamento Já Aceito',
    billingContractSlug: 'Código do Contrato',
    billingContractTerms: 'Termos do Contrato de Faturamento',
    by: 'por',
