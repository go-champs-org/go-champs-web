...
import {
  ...
  deleteTournamentGroupFailure,
  deleteTournamentGroupSuccess,
  patchTournamentGroup,
  patchTournamentGroupFailure,
  patchTournamentGroupSuccess,
  postTournamentGroup,
...
describe('deleteTournamentGroup', () => {
  ...
  it('sets isLoadingDeleteTournamentGroup to true', () => {
    expect(
      deleteTournamentGroup(initialState, action).isLoadingDeleteTournamentGroup
    ).toBe(true);
  });
});
...
describe('deleteTournamentGroupFailure', () => {
  ...
  it('sets isLoadingDeleteTournamentGroup to false', () => {
    expect(
      deleteTournamentGroupFailure(initialState, action)
        .isLoadingDeleteTournamentGroup
    ).toBe(false);
  });
});
...
describe('deleteTournamentGroupSuccess', () => {
  ...
  it('sets isLoadingDeleteTournamentGroup to false', () => {
    expect(
      deleteTournamentGroupSuccess(deleteState, action)
        .isLoadingDeleteTournamentGroup
    ).toBe(false);
  });
...
describe('patchTournamentGroup', () => {
  ...
  it('sets isLoadingPatchTournamentGroup to true', () => {
    expect(
      patchTournamentGroup(initialState, action).isLoadingPatchTournamentGroup
    ).toBe(true);
  });
});
...
describe('patchTournamentGroupFailure', () => {
  ...
  it('sets isLoadingPatchTournamentGroup to false', () => {
    expect(
      patchTournamentGroupFailure(initialState, action)
        .isLoadingPatchTournamentGroup
    ).toBe(false);
  });
});
...
describe('patchTournamentGroupSuccess', () => {
  ...
  it('sets isLoadingPatchTournamentGroup to false', () => {
    expect(
      patchTournamentGroupSuccess(updateState, action)
        .isLoadingPatchTournamentGroup
    ).toBe(false);
  });
...
describe('postTournamentGroup', () => {
  ...
  it('sets isLoadingPostTournamentGroup to true', () => {
    expect(
      postTournamentGroup(initialState, action).isLoadingPostTournamentGroup
    ).toBe(true);
  });
});
...
describe('postTournamentGroupFailure', () => {
  ...
  it('sets isLoadingPostTournamentGroup to false', () => {
    expect(
      postTournamentGroupFailure(initialState, action)
        .isLoadingPostTournamentGroup
    ).toBe(false);
  });
});
...
describe('postTournamentGroupSuccess', () => {
  ...
  it('sets isLoadingPostTournamentGroup to false', () => {
    expect(
      postTournamentGroupSuccess(initialState, action)
        .isLoadingPostTournamentGroup
    ).toBe(false);
  });
