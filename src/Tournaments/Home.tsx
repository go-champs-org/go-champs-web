...
const Home: React.FC<HomeProps> = ({ currentOrganizationSlug, currentTournamentSlug, tournamentState, tournamentGameState, tournamentGroupState, tournamentTeamState, url }) => {
