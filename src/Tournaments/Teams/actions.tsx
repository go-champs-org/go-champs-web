...
export const PATCH_TOURNAMENT_TEAM_SUCCESS = 'API_PATCH_TOURNAMENT_TEAM_SUCCESS';
export const PATCH_TOURNAMENT_TEAM_FAILURE = 'API_PATCH_TOURNAMENT_TEAM_FAILURE';
...
export const patchTournamentTeam = (tournamentId: string) => (tournamentTeam: TournamentTeamEntity): HttpAction<ActionTypes> => ({
	type: PATCH_TOURNAMENT_TEAM, payload: {
		url: `${tournamentTeamsAPI(tournamentId)}/${tournamentTeam.id}`, requestConfig: {
			method: 'PATCH',
			headers: {
...
export const patchTournamentTeamSuccess = (payload: any): HttpAction<ActionTypes> => ({
	type: PATCH_TOURNAMENT_TEAM_SUCCESS,
	payload,
});

export const patchTournamentTeamFailure = (payload: any): HttpAction<ActionTypes> => ({
